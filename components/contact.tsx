        ...
        <div className="flex flex-col md:flex-row items-center md:justify-evenly gap-6">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-xs md:text-sm text-blue-200">Email</p>
              <p className="text-sm md:text-lg font-semibold break-all">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-xs md:text-sm text-blue-200">Teléfono</p>
